...
- [x] **Step 4: Create the Template model**
...
- [x] **Step 4: Implement the migration revision**
...
- [x] **Step 6: Update Flow SQLModel to match the schema**
...
- [x] **Step 7: Update TemplateMetadata SQLModel**
...
- [x] **Step 3: Create the templates router**
...
- [x] **Step 3: Retarget the admin metadata endpoints**
...
- [x] **Step 3: Replace the seeding function**
...
- [x] **Step 1: Read each file at the cited line to understand context**
...
- [x] **Step 2: Update `services/database/service.py`**
...
- [x] **Step 3: Update `api/v1/projects.py`**
...
- [x] **Step 4: Update `api/v1/flows.py`**
...
- [x] **Step 5: Retire `services/database/models/flow/starter.py`**
...
- [x] **Step 6: Run the full backend test suite to confirm nothing broke**
...
- [x] **Step 3: Rewrite `template_apply.py`**
...
- [x] **Step 4: Update callers of the renamed parameter**
...
- [x] **Step 1: Update `flow_template_context.py`**
...
- [x] **Step 2: Update `services/assistant/service.py`**
...
- [x] **Step 3: Update `api/v1/assistant.py`**
...
- [x] **Step 4: Grep-verify no stragglers remain**
...
- [x] **Step 5: Run the backend test suite to confirm nothing broke**
...
- [x] **Step 1: Read the current endpoint**
...
- [x] **Step 2: Retarget to read from Template**
...
- [x] **Step 3: Add a smoke test (optional — existing tests should cover it)**
...
- [x] **Step 2: Create `useListTemplates`**
...
- [x] **Step 3: Create `useGetTemplate`**
...
- [x] **Step 4: Create `useCreateTemplate`**
...
- [x] **Step 5: Create `useUpdateTemplate`**
...
- [x] **Step 6: Create `useDeleteTemplate`**
...
- [x] **Step 2: Rename each occurrence**
...
- [x] **Step 1: Read the current structure**
...
- [x] **Step 3: Adapt `GetStartedComponent`**
...
- [x] **Step 3: Implement `field-review-panel.tsx`**
...
- [x] **Step 3: Implement the modal container**
...
- [x] **Step 1: Locate the Share menu**
...
- [x] **Step 2: Add "Save as Template" item for superusers**
...
- [x] **Step 1: Read the existing flows-tab**
...
- [x] **Step 2: Update the metadata query hook**
...
- [x] **Step 3: Alembic upgrade against a fresh dev DB**
...
- [x] **Step 4: Alembic upgrade against an existing dev DB with starter-project Flow rows**
...
- [x] **Step 5: Manual verification — template catalog**
...
- [x] **Step 6: Manual verification — save-as-template**
...
- [x] **Step 10: Manual verification — soft delete**
