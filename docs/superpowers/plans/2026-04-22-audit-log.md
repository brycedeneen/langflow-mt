...
- [ ] **Step 1: Enrich the context once the user is resolved**
...
- [ ] **Step 1: Add failing tests for model-aware serialization**
...
- [ ] **Step 3: Wire the listener into `DatabaseService`**
