...
- [ ] **Step 1.3: Create the minimal component stub**
...
- [ ] **Step 2.1: Write the failing tests for the map**
...
- [ ] **Step 2.3: Implement the reverse lookup helper**
...
- [ ] **Step 3.1: Write the failing tests for inputs**
...
- [ ] **Step 3.3: Implement the inputs and outputs**
...
- [ ] **Step 4.1: Update the bundle init test to fail**
...
- [ ] **Step 5.1: Write the failing extraction tests**
...
- [ ] **Step 5.3: Implement the extraction helpers**
...
- [ ] **Step 6.1: Write failing tests for `_event_matches_selection`**
...
- [ ] **Step 6.3: Implement the matcher**
...
- [ ] **Step 8.1: Write failing tests for filtering + edge cases**
...
- [ ] **Step 9.1: Write the failing routing unit test**
...
- [ ] **Step 9.2: Run the tests to verify the ADP-trigger tests fail**
...
- [ ] **Step 9.4: Run the full routing test file**

Run: `uv run pytest src/backend/tests/unit/api/v1/test_adp_trigger_webhook_routing.py -v`

Expected: all 5 tests PASS.

- [ ] **Step 9.5: Re-run any existing tests that import these helpers**
...
- [ ] **Step 10.1: Write a failing import-from-bundle test**
...
- [ ] **Step 11.2: Component catalog visibility**
...
- [ ] **Step 11.3: Webhook API key provisioning**
...
- [ ] **Step 11.4: Inbound POST routing**
...
- [ ] **Step 11.5: Filtering in the inbound path**
...
- [ ] **Step 11.6: Flow delete cleans up the key**
...
- [ ] **Step 11.7: Report manual test results**
