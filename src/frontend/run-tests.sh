...
# Start the backend
LANGFLOW_DATABASE_URL=sqlite:///./temp LANGFLOW_SUPERUSER=langflow LANGFLOW_SUPERUSER_PASSWORD=langflow poetry run langflow run --backend-only --port 7860 --host 0.0.0.0 --no-open-browser > /dev/null 2>&1 &
