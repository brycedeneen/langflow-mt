  ...
  >(({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        className={cn(
          "flex shrink-0 items-center rounded-md text-xs font-semibold text-foreground/70 outline-hidden ring-ring transition-[margin,opa] duration-200 ease-linear focus-visible:ring-1 [&>svg]:size-4 [&>svg]:shrink-0",
