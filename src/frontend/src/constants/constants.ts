...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the Amplify documentation for more information on how to write your own component.";
...
export const DESCRIPTIONS: string[] = [
  ...
  "Amplify: Create, Chain, Communicate.",
...
export const API_PAGE_PARAGRAPH =
  "Your secret Amplify API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const LANGFLOW_CHAT_TITLE = "Amplify Chat";
...
export const INSERT_API_KEY = "Insert your Amplify API key.";
