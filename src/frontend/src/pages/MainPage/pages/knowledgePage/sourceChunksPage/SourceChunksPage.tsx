                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-1.5 px-2 text-sm">
                          ...
                          <input
                            ...
                            className="h-7 w-16 rounded border border-input bg-background px-2 text-center text-sm focus:outline-hidden focus:ring-1 focus:ring-ring [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-inner-spin-button]:opacity-100 [&::-webkit-inner-spin-button]:[filter:invert(1)] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-outer-spin-button]:opacity-100 [&::-webkit-outer-spin-button]:[filter:invert(1)]"
                          />
