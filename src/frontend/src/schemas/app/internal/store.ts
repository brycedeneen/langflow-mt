...
export const TagResponseSchema = z.looseObject({
  id: z.string(),
...
export const UsersLikesResponseSchema = z.looseObject({
...
export const CreateComponentResponseSchema = z.looseObject({
  id: z.string(),
});
...
export const ListComponentResponseSchema = z.looseObject({
  ...
  user_created: z.record(z.string(), z.unknown()).optional().nullable(),
...
export const ListComponentResponseModelSchema = z.looseObject({
...
export const DownloadComponentResponseSchema = z.looseObject({
  id: z.string(),
  name: z.string().optional().nullable(),
  description: z.string().optional().nullable(),
...
export const StoreCheckResponseSchema = z.looseObject({
  enabled: z.boolean(),
});
...
export const StoreCheckApiKeyResponseSchema = z.looseObject({
