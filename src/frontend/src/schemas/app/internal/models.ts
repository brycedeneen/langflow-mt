...
// ---------------------------------------------------------------------------
export const ProviderModelsDictSchema = z
  .object({
...
export const EnabledProvidersResponseSchema = z
  .object({
    enabled_providers: z.array(z.string()).optional(),
    provider_status: z.record(z.boolean()).optional(),
  })
  .passthrough();
...
export const EnabledModelsResponseSchema = z
  .object({
    enabled_models: z.record(z.record(z.boolean())).optional(),
  })
  .passthrough();
...
export const UpdateEnabledModelsResponseSchema = z
  .object({
...
// ---------------------------------------------------------------------------
export const DefaultModelDataSchema = z
  .object({
    model_name: z.string().optional(),
    provider: z.string().optional(),
    model_type: z.string().optional(),
...
export const GetDefaultModelResponseSchema = z
  .object({
...
export const SetDefaultModelResponseSchema = z
  .object({
...
export const ClearDefaultModelResponseSchema = z
  .object({
