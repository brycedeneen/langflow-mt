...
async def compute_cost_for_run(
    ...
    *,
    ...
    for span in spans:
        ...
        # Production spans (native tracer in services/tracing/native.py) use
        # OTel GenAI keys; legacy litellm-style keys are kept as fallbacks for
        # any external/3rd-party span source.
        model = str(
